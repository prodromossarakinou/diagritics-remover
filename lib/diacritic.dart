...
/// Case insensitive, intonation insensitive ;
String removeDiacriticsAndIntonation(String text) =>
    String.fromCharCodes(replaceCodeUnits(text.toLowerCase().codeUnits));
