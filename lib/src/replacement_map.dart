...
void _initIfMap() {
  ...
  _register(' ', '\u00A0');
  _register('A',
      '\u0041\u24B6\uFF21\u00C0\u00C1\u00C2\u1EA6\u1EA4\u1EAA\u1EA8\u00C3\u0100\u0102\u1EB0\u1EAE\u1EB4\u1EB2\u0226\u01E0\u00C4\u01DE\u1EA2\u00C5\u01FA\u01CD\u0200\u0202\u1EA0\u1EAC\u1EB6\u1E00\u0104\u023A\u2C6F\u0386\u0391\u038A');
  _register('AA', '\uA732');
  _register('AE', '\u00C6\u01FC\u01E2');
  _register('AO', '\uA734');
  _register('AU', '\uA736');
  ...
  _register('Dz', '\u01F2\u01C5');
  _register('E',
      '\u0045\u24BA\uFF25\u00C8\u00C9\u00CA\u1EC0\u1EBE\u1EC4\u1EC2\u1EBC\u0112\u1E14\u1E16\u0114\u0116\u00CB\u1EBA\u011A\u0204\u0206\u1EB8\u1EC6\u0228\u1E1C\u0118\u1E18\u1E1A\u0190\u018E\u0388');
  _register('F', '\u0046\u24BB\uFF26\u1E1E\u0191\uA77B');
  _register('G',
      '\u0047\u24BC\uFF27\u01F4\u011C\u1E20\u011E\u0120\u01E6\u0122\u01E4\u0193\uA7A0\uA77D\uA77E');
  _register('H',
  ...
  _register('Nj', '\u01CB');
  _register('O',
      '\u004F\u24C4\uFF2F\u00D2\u00D3\u00D4\u1ED2\u1ED0\u1ED6\u1ED4\u00D5\u1E4C\u022C\u1E4E\u014C\u1E50\u1E52\u014E\u022E\u0230\u00D6\u022A\u1ECE\u0150\u01D1\u020C\u020E\u01A0\u1EDC\u1EDA\u1EE0\u1EDE\u1EE2\u1ECC\u1ED8\u01EA\u01EC\u00D8\u01FE\u0186\u019F\uA74A\uA74C\u039F\u038C\u03A9\u038F');
  _register('OI', '\u01A2');
  _register('OO', '\uA74E');
  _register('OU', '\u0222');
  _register(
  ...
  _register('dz', '\u01F3\u01C6');
  _register('e',
      '\u0065\u24D4\uFF45\u00E8\u00E9\u00EA\u1EC1\u1EBF\u1EC5\u1EC3\u1EBD\u0113\u1E15\u1E17\u0115\u0117\u00EB\u1EBB\u011B\u0205\u0207\u1EB9\u1EC7\u0229\u1E1D\u0119\u1E19\u1E1B\u0247\u025B\u01DD\u03AD\u03B5');
  _register('f', '\u0066\u24D5\uFF46\u1E1F\u0192\uA77C');
  _register('ff', '\uFB00');
  _register('fi', '\uFB01');
  _register('fl', '\uFB02');
  ...
  _register('nj', '\u01CC');
  _register('o',
      '\u07C0\u006F\u24DE\uFF4F\u00F2\u00F3\u00F4\u1ED3\u1ED1\u1ED7\u1ED5\u00F5\u1E4D\u022D\u1E4F\u014D\u1E51\u1E53\u014F\u022F\u0231\u00F6\u022B\u1ECF\u0151\u01D2\u020D\u020F\u01A1\u1EDD\u1EDB\u1EE1\u1EDF\u1EE3\u1ECD\u1ED9\u01EB\u01ED\u00F8\u01FF\u0254\uA74B\uA74D\u0275\u03CC\u03BF\u03C9\u03CE');
  _register('oe', '\u0152\u0153');
  _register('oi', '\u01A3');
  _register('ou', '\u0223');
  _register('oo', '\uA74F');
